...
namespace Player
{
    public partial class MediaView : UserControl
    {
        ...
        public MediaView(int index, string main, string sub, MediaType type = MediaType.Music)
        {
            ...
            MainIcon.Icon = type == MediaType.Music ? MaterialIcons.MaterialIconType.ic_music_note : MaterialIcons.MaterialIconType.ic_ondemand_video;
        ...
        public void Revoke(int index, string main, string sub, MediaType type = MediaType.Music)
        {
            ...
            MainLabel.Content = main;
            SubLabel.Content = sub;
            MainIcon.Icon = type == MediaType.Music ? MaterialIcons.MaterialIconType.ic_music_note : MaterialIcons.MaterialIconType.ic_music_video;
        }
        ...
        {
            DoubleClicked?.Invoke(this, new MediaEventArgs() { Index=MediaIndex});
        }
    }
}
